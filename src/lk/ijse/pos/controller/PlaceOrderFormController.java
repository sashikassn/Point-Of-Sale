...
public class PlaceOrderFormController implements Initializable {
    ...
    CustomerBO customerBO = (CustomerBO)BOFactory.getInstance().getBO(BOFactory.BOType.CustomerBO);
    ItemBO itemBO = (ItemBO)BOFactory.getInstance().getBO(BOFactory.BOType.ItemBO);
    ...
    private void placeOrderPressed(ActionEvent event) {
        try {
            ...
            if(fresult1 && fresult2){
                ...
                new Alert(Alert.AlertType.CONFIRMATION,"Order Has been Placed Successfully !!!",ButtonType.OK).show();
            }else{
